          ...
          <div className="relative pt-12 w-full">
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full bg-brand text-white font-semibold rounded-xl py-3 hover:bg-opacity-90 active:scale-95 transition-all"
              >
                Choose Split Method →
              </button>
            </div>
        ...
        {step === 2 && (
          <div className="flex flex-col items-center w-full min-h-[60vh] relative pt-8">
            ...
            <div className="mt-8 text-center w-full">
              <h2 className="text-2xl font-bold text-main mb-2">How do you want to split?</h2>
              <p className="text-subtle mb-8 text-sm">Select a method for this bill</p>
            </div>
